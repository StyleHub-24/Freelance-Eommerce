...
const Suggestedreview = ({ token }) => {
  ...
  const [categories, setCategories] = useState(['Topwear', 'Bottomwear', 'Winterwear']); // Example categories
  ...
  return (
    <div className="p-6 border rounded-md bg-white shadow-lg">
      <h1 className="text-xl font-bold mb-4 text-center">Add Suggested Reviews</h1>
